...
class RegexTokenizer(Tokenizer):
    ...
    def building_merges(self, text, vocab_size, verbose=False):
        """
        Trains the tokenizer using the BPE algorithm with regex splitting.
        ...
        """
        # Convert text to bytes and initialize ids with regex splitting
        ...
        # Encode each chunk to bytes and flatten into a single id list
        ids = []
